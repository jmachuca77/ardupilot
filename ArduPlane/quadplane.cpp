...
const AP_Param::GroupInfo QuadPlane::var_info2[] = {
    ...
    // @Description: This is the vehicle the weight in kg divided by the total disk area of all propellers in m^2. Units of kg/m^2. Only used with Q_TAILSIT_GSCMSK = 4
    // @User: Standard
